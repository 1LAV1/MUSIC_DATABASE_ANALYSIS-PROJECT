...
max_genre_per_country as ( select max(purchases_per_genre) as max_genre_count , country
...
where max_genre_per_country.max_genre_count = sales_per_country.purchases_per_genre
...
join country_max_spent on country_max_spent.billing_country = cc.billing_country
where cc.total_spending = country_max_spent.max_Spending
order by 1